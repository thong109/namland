...
const ProjectNewInfo: React.FC<ProjectInfoProps> = ({ locale, projectDetail }) => {
    ...
    <>
      <div className='article-common-information article-common-information--details article-common-information--details-custom'>
        <div className='article-common-information__wrapper' id='overview'>
          <h1 className='article-common-information__title'>{t('EcomPropertyDetailPageLocationOverview', { name: projectDetail?.title })}</h1>
          <div className='article-common-information__block'>
            ...
            <div className='article-common-information__block-column'>
              <dl className='article-common-information__block-row'>
                ...
                <dd className='article-common-information__block-description'>{projectDetail?.title}</dd>
              </dl>
              <dl className='article-common-information__block-row'>
                <dt className='article-common-information__block-title'>{t('EcomProjectDetailOwnership')}</dt>
                <dd className='article-common-information__block-description'>{projectDetail?.types?.length ? projectDetail?.types.map(i => i.name).join(', ') : '—'}</dd>
              </dl>
              <dl className='article-common-information__block-row'>
        ...
        <div className='article-common-information__wrapper' id='partner'>
          <span className='article-common-information__title'>{t('EcomPropertyDetailPageLocationPartner', { name: projectDetail?.title })}</span>
