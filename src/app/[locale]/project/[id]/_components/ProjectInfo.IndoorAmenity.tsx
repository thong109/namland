...
interface ProjectInfoIndoorAmenityProps {
  locale: string;
  projectDetail: ProjectDetailModel;
}

const ProjectInfoIndoorAmenity: React.FC<ProjectInfoIndoorAmenityProps> = ({
  locale,
  projectDetail,
}) => {
  ...
  const amenities = useMemo(
    () => projectDetail?.indoorAmenities ?? [],
    [projectDetail, projectDetail?.indoorAmenities],
  );
...
export default React.memo(ProjectInfoIndoorAmenity);
