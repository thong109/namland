...
import { blockKeyEnter } from '@/libs/helper';
...
const RentFavorite = (props: IProps) => {
  ...
  const getListFavorite = async () => {
    const favoriteResponse = await favoriteApiService.getListFarvorite(filter);
