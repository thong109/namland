...
const TsAndCsPageMobile: FC<Props> = ({ params }) => {
  ...
  const getDetail = async () => {
    const data = await TsAndCsService.getData({ type: TypeModuleEnum.OperatingRegulations });
    setDataTsAndCs(data);
    if (data === null) {
