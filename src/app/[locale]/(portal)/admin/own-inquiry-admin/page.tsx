...
import { align, appPermissions, listStatusOwnInquiry, roleAdminGod } from '@/libs/appconst';
...
const TicketManagementForStaff: React.FC = () => {
  ...
  const getOwnInquiryStaff = async () => {
    const responseData: any = await apiTicketManagement.getListOwnInquiryForStaff(filter);
  ...
  const onEdit = (id: string) => {
    if (id) {
      push(`/admin/own-inquiry-admin/${id}`);
    }
  };
...
export default TicketManagementForStaff;
