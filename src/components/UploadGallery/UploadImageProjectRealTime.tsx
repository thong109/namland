...
const UploadImageProjectRealTime: FC<InputProps> = ({
  title = 'Upload',
  ...
  const uploadFiles = async (files: File[]) => {
    const listFileAfterUpload: any = await fileApiService.uploadFilesProject(files);
...
export default UploadImageProjectRealTime;
