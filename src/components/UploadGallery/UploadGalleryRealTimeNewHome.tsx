...
const UploadGalleryRealTimeNewHome: FC<InputProps> = ({
  title = 'Upload',
  ...
  const uploadFiles = async (files: File[]) => {
    const listFileAfterUpload: any = await fileApiService.uploadFilesNewHome(files);
...
export default UploadGalleryRealTimeNewHome;
