...
const UploadGalleryRealTime: FC<InputProps> = ({
  title = 'Upload',
  ...
  const uploadFiles = async (files: File[]) => {
    const listFileAfterUpload: any = await fileApiService.uploadFilesListing(files);
...
export default UploadGalleryRealTime;
