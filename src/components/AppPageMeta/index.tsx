...
const defaultTitle = 'BĐS Dom Dom';
...
const AppPageMeta: React.FC<AppPageMetaProps> = ({ children, ...rest }) => {
  const getMetaTags = ({
    ...
    updated,
    category = 'canho, apartment, ',
    tags = 'batdongsan,batdongsanpmh,batdongsancanban,batdongsanchothue,realestateforsale,realestateforrent ',
  }: AppPageMetaProps) => {
    ...
    const metaTags = [
      ...
      { itemprop: 'image2222', content: theTitle },
